...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'WP Fleet Core API — multi-tenant WordPress fleet management. Authenticate with Bearer JWT (claim tenant_id). Plugin routes use HMAC and are documented separately.',
    ],
